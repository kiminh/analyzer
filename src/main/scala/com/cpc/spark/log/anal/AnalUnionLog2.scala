...
object AnalUnionLog2 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    var searchData = prepareSource(spark, "cpc_search", "cpc_search", hourBefore, 1)
    if (searchData == null) {
    ...
    val showData = prepareSource(spark, "cpc_show", "cpc_show", hourBefore, 2)
    ...
    val traceData = prepareSource(spark, "cpc_trace", "cpc_trace", hourBefore, 2)
    if (traceData != null) {
