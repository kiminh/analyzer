...
object AnalUnionLog3 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val traceData1 = prepareSource(spark, "cpc_trace", "src_cpc_trace", hourBefore, 1)
    if (traceData1 != null) {
      traceData = traceData.union(prepareTraceSource(traceData1))
    }
    val traceData2 = prepareSource(spark, "cpc_trace", "src_cpc_trace", hourBefore - 1, 1)
    if (traceData2 != null) {
