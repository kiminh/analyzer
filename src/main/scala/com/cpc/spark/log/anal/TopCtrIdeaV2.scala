...
object TopCtrIdeaV2 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val topIdeaRDD = adinfo
      ...
      .filter(x => x != null && !Seq(1537507, 1540081, 1544700, 1544832, 1545016, 1545020, 1545025, 1545197, 1545200, 1545202, 1547033, 1549325, 1549327,
        1549328, 1549329, 1549342, 1552330, 1552333, 1552336, 1552339, 1552340, 1552545, 1552551, 1552553, 1552562, 1552565,1001028,1501897).contains(x.user_id) &&
        !(
