  ...
  def ftrlUnionLog(date: String, hour:String, featureColumns: Seq[String], tableName: String, spark: SparkSession) ={
    ...
    var sqlRequest =
      s"""
         ...
         |        a.adtype,
         |        a.interaction,
         |        a.ext["phone_level"].int_value as phone_level,
         |        a.int(hour) as hour,
         |        a.os,
         |        a.isp,
         |        a.adslotid,
         |        a.ext["city_level"].int_value as city_level,
         |        a.ext["pagenum"].int_value as pagenum,
         |        a.ext["user_req_ad_num"].int_value as user_req_ad_num,
         |        a.ext["user_req_num"].int_value as user_req_num,
         |        a.ext["click_count"].int_value as click_count,
         |        a.ext["click_unit_count"].int_value as click_unit_count,
         |        a.ext["long_click_count"].int_value as long_click_count,
         |        a.ctr as base_ctr
         | from
         |      (
         |        select *
