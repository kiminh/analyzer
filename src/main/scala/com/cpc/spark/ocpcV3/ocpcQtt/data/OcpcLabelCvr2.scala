...
object OcpcLabelCvr2 {
  def main(args: Array[String]): Unit = {
    ...
    result.write.mode("overwrite").saveAsTable("test.ocpcv3_qtt_cvr2_data_hourly")
//    result.write.mode("overwrite").insertInto("dl_cpc.ocpcv3_qtt_cvr2_data_hourly")
    println("successfully save data into table: dl_cpc.ocpcv3_qtt_cvr2_data_hourly")
  }
  ...
  def getLabelBak(date: String, hour: String, spark: SparkSession) = {
    ...
    val resultDF = labelData
      ...
      .select("ideaid", "unitid", "adclass", "cvr2_cnt")
