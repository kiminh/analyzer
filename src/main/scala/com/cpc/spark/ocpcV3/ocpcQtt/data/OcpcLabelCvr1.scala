...
object OcpcLabelCvr1 {
  def main(args: Array[String]): Unit = {
    ...
    val tableName = "dl_cpc.ocpcv3_qtt_cvr1_data_hourly"
    result.write.mode("overwrite").saveAsTable("test.ocpcv3_qtt_cvr1_data_hourly")
//    result.write.mode("overwrite").insertInto("dl_cpc.ocpcv3_qtt_cvr1_data_hourly")
  ...
  def getLabel(date: String, hour: String, spark: SparkSession) = {
    ...
    val resultDF = rawData
      ...
      .select("ideaid", "unitid", "adclass", "cvr1_cnt")
