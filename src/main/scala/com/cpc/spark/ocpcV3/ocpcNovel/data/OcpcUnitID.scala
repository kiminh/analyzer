...
object OcpcUnitID {
  def main(args: Array[String]): Unit = {
    ...
    val table = "(select id, bid, ocpc_bid, ocpc_bid_update_time, cast(conversion_goal as char) as conversion_goal from adv.unit where is_ocpc=1 and ideas is not null) as tmp"
