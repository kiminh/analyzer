...
//    println(s"save data into table: $tableName")
  ...
  def getBaseData(date: String, hour: String, days: Int, spark: SparkSession) = {
    ...
    val costData = spark
      ...
      .select("unitid", "new_adclass", "total_cost", "total_bid", "ctrcnt")
    ...
    val cvr1Data = spark
      ...
      .select("unitid", "new_adclass", "cvr1cnt")
