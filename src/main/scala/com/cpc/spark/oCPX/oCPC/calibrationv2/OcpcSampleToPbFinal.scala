...
object OcpcSampleToPbFinal {
  def main(args: Array[String]): Unit = {
    ...
    val result1 = data1
      .selectExpr("cast(identifier as int) unitid", "conversion_goal", "is_hidden", "exp_tag", "cali_value", "jfb_factor", "post_cvr", "high_bid_factor", "low_bid_factor", "cpa_suggest", "smooth_factor", "cpagiven")
