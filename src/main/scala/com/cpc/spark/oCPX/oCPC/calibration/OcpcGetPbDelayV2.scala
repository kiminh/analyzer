...
import com.cpc.spark.oCPX.oCPC.calibration.OcpcCVRfactorV2.OcpcCVRfactorV2Main
...
import com.cpc.spark.oCPX.oCPC.calibration.OcpcJFBfactorV2.OcpcJFBfactorV2Main
import com.cpc.spark.oCPX.oCPC.calibration.OcpcSmoothfactor._
import com.cpc.spark.oCPX.oCPC.calibration.OcpcSmoothfactorV2.OcpcSmoothfactorV2Main
...
object OcpcGetPbDelayV2 {
  def main(args: Array[String]): Unit = {
    ...
    val data = OcpcGetPbDelayV2Main(date, hour, version, expTag, jfbHourInt, smoothHourInt, bidFactorHourInt, hourInt1, hourInt2, hourInt3, 6, spark)
...
//      .write.mode("overwrite").insertInto("test.ocpc_pb_data_hourly")
  ...
  def OcpcGetPbDelayV2Main(originalDate: String, originalHour: String, version: String, expTag: String, jfbHourInt: Int, smoothHourInt: Int, bidFactorHourInt: Int, hourInt1: Int, hourInt2: Int, hourInt3: Int, delayHour: Int, spark: SparkSession) = {
    // 取历史数据
