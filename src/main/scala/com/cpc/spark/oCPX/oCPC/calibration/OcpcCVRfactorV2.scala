...
object OcpcCVRfactorV2 {
  ...
  def OcpcCVRfactorV2Main(date: String, hour: String, version: String, expTag: String, hourInt1: Int, hourInt2: Int, hourInt3: Int, spark: SparkSession) = {
    val data1 = OcpcCalibrationBaseMain(date, hour, version, expTag, hourInt1, spark).cache()
    data1.show(10)
    val data2 = OcpcCalibrationBaseMain(date, hour, version, expTag, hourInt2, spark).cache()
    data2.show(10)
    val data3 = OcpcCalibrationBaseMain(date, hour, version, expTag, hourInt3, spark).cache()
    data3.show(10)
