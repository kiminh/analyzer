...
object OcpcPIDretrieveData{
  def main(args: Array[String]): Unit = {
    ...
    baseData
      .repartition(10)
      .write.mode("overwrite").saveAsTable("test.check_ocpc_data20190822")
  }


  def getBaseDataV1(hourInt: Int, date: String, hour: String, spark: SparkSession) = {
    // 抽取媒体id
