...
object OcpcCalibrationFactor {
  def main(args: Array[String]): Unit = {
    ...
    val result = OcpcCalibrationFactorMain(date, hour, hourInt, expTag, minCV, spark).cache()

    result
      .repartition(10).write.mode("overwrite").saveAsTable("test.check_ocpc_factor20191029a")
  }

  def OcpcCalibrationFactorMain(date: String, hour: String, hourInt: Int, expTag: String, minCV: Int, spark: SparkSession) = {
