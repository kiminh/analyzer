...
object OcpcCVRfactor {
  ...
  def OcpcCVRfactorMain(date: String, hour: String, version: String, expTag: String, dataRaw: DataFrame, hourInt1: Int, hourInt2: Int, hourInt3: Int, spark: SparkSession) = {
    ...
    val data1 = selectDataByHourInt(dataRaw, date, hour, hourInt1, minCV, expTag, spark)

    val data2 = selectDataByHourInt(dataRaw, date, hour, hourInt2, minCV, expTag, spark)

    val data3 = selectDataByHourInt(dataRaw, date, hour, hourInt3, minCV, expTag, spark)
  ...
  def selectDataByHourInt(dataRaw: DataFrame, date: String, hour: String, hourInt: Int, minCV: Int, expTag: String, spark: SparkSession) = {
