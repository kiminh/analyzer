package com.cpc.spark.oCPX.bsOcpc
...
object OcpcBsData {
  def main(args: Array[String]): Unit = {
    ...
    result
        ...
        .repartition(5)
        .write.mode("overwrite").insertInto("test.ocpc_bs_params_pb_hourly_exp")
//        .write.mode("overwrite").insertInto("dl_cpc.ocpc_bs_params_pb_hourly_exp")
