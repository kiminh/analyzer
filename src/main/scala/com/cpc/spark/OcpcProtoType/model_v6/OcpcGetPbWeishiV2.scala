...
object OcpcGetPbWeishiV2 {
  def main(args: Array[String]): Unit = {
    ...
    val result = OcpcGetPbWeishiMain(date, hour, version, media, expTag, hourInt, minCV, hourInt1, hourInt2, hourInt3, spark)
...
//      .write.mode("overwrite").insertInto("test.ocpc_param_calibration_hourly_v2")
  ...
  def OcpcGetPbWeishiMain(originalDate: String, originalHour: String, version: String, media: String, expTag: String, hourInt: Int, minCV: Int, hourInt1: Int, hourInt2: Int, hourInt3: Int, spark: SparkSession) = {
    // 取历史数据
