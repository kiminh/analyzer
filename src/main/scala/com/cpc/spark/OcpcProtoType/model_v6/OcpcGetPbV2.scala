...
import com.cpc.spark.OcpcProtoType.model_v6.OcpcGetPbWeishi.OcpcGetPbWeishiMain
...
//    val hour = tmpDateValue(1)
    ...
    val result2 = OcpcGetPbWeishiMain(date, hour, version, media, highBidFactor, lowBidFactor, hourInt, minCV, hourInt1, hourInt2, hourInt3, spark)
