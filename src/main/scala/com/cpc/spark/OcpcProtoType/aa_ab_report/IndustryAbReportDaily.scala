...
import com.cpc.spark.OcpcProtoType.aa_ab_report.IndustryAbReportHourly.getIndexValue
import org.apache.spark.sql.{DataFrame, SparkSession}
import org.apache.spark.sql.functions.lit

object IndustryAbReportDaily {
  ...
  def getIndexValue(date: String, hour: String, spark: SparkSession): Unit ={
    ...
    dataDF
      ...
      .repartition(50)
      .write.mode("overwrite").insertInto("dl_cpc.ocpc_industry_ab_report_daily")
