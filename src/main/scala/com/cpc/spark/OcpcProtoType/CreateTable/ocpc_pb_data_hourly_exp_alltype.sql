...
create table if not exists test.ocpc_pb_data_hourly_exp_alltype(
    identifier              string,
    conversion_goal         int,
    jfb_factor              double,
    post_cvr                double,
...
create table dl_cpc.ocpc_pb_data_hourly_exp_alltype
like test.ocpc_pb_data_hourly_exp_alltype;
