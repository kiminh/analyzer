...
--alter table dl_cpc.ocpc_base_unionlog add columns (ocpc_expand int);
--alter table dl_cpc.ocpc_base_unionlog add columns (expids string);
--alter table dl_cpc.ocpc_base_unionlog add columns (bsctr bigint);
--alter table dl_cpc.ocpc_base_unionlog add columns (raw_cvr bigint);
--alter table dl_cpc.ocpc_base_unionlog add columns (deep_cvr bigint);
--alter table dl_cpc.ocpc_base_unionlog add columns (raw_deep_cvr bigint);
--alter table dl_cpc.ocpc_base_unionlog add columns (deep_cvr_model_name string);
--alter table dl_cpc.ocpc_base_unionlog add columns (deep_ocpc_log string);
--alter table dl_cpc.ocpc_base_unionlog add columns (is_deep_ocpc int);
--alter table dl_cpc.ocpc_base_unionlog add columns (deep_conversion_goal int);
--alter table dl_cpc.ocpc_base_unionlog add columns (deep_cpa bigint);
--alter table dl_cpc.ocpc_base_unionlog add columns (cpa_check_priority int);
--alter table dl_cpc.ocpc_base_unionlog add columns (ocpc_expand_tag int);
alter table test.ocpc_base_unionlog add columns (ori_cvr bigint);
alter table test.ocpc_base_unionlog add columns (uid_mc_show0 bigint);
alter table test.ocpc_base_unionlog add columns (uid_mc_click0 bigint);
