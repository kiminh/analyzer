...
alter table test.ocpc_report_base_hourly add columns (deep_click bigint, deep_cv bigint, total_deepcvr double, total_deep_cpagiven bigint, total_deep_jfbfactor double, total_deep_cvrfactor double, total_deep_calipcvr double, total_deep_smooth_factor double, real_deep_click bigint, total_deep_price bigint, total_deep_bid bigint);
