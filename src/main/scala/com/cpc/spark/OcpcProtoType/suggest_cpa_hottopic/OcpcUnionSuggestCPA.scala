...
object OcpcUnionSuggestCPA {
  def main(args: Array[String]): Unit = {
    ...
    val cvr1Cali = getNewCali("hottopic", baseResult, 1, 48, date, hour, spark)
    val cvr2Cali = getNewCali("hottopic", baseResult, 2, 48, date, hour, spark)
    val cvr3Cali = getNewCali("hottopic", baseResult, 3, 48, date, hour, spark)
