...
object video_sample_v2 {
  ...
  def getSample(spark: SparkSession, date: String): DataFrame = {
    ...
    val video_sample_new = video_sample.join(ideaid_feature, Seq("ideaidhash"), "left_outer")
    val original_sample_new = original_sample.join(ideaid_feature, Seq("ideaidhash"), "left_outer")
