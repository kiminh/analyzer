...
object CtrAllMediaModel {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val ctx = model.initSpark("cpc ctr all media model %s [%s]".format(mode, modelPath))
    ...
    CUtils.sendMail(txt, "CTR all media model train " + result, Seq("cpc-rd@innotechx.com","rd@aiclk.com"))
