  ...
  def main(args: Array[String]): Unit = {
    ...
    val trainSql =
      s"""
         ...
         |  , ideaid
         |  , adclass
         |  , adslotid -- bottom-up compatibility.
         |  , adslot_type
         |  , pagenum -- bottom-up compatibility.
         |  , bookid -- bottom-up compatibility.
         |  , brand_title
         |  , user_req_num
         |  , uid
         |  , user_click_num
         |  , user_click_unit_num
         |  , user_long_click_count
         |  , phone_price
         |  , province
         |  , city_level
         |  , media_type
         ...
         |  , is_new_ad
         |  , hour
         |  , IF(b.searchid is not null,1,0) as label from
         |(select
         |  searchid
         |  , isclick as label
         |  , sex
         ...
         |  userid in (1666928)
         |  and unitid in (2411411, 2424481, 2426812, 2427591)
         |  and array_contains(conversion_target, 'api_app_pay')
         |  and day>='2019-10-11')b
