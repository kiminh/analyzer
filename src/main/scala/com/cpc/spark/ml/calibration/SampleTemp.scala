...
object SampleTemp {
  def main(args: Array[String]): Unit = {
   ...
   val move ="hdfs dfs -put -f /home/cpc/wy/calibration_sample/calibration_sample-v5conv5-train.csv hdfs://emr-cluster/user/cpc/wy/calibration_sample-v5conv5-train.csv"
    move !
  }
