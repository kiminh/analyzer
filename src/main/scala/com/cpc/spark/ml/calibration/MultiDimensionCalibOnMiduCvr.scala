...
object MultiDimensionCalibOnMiduCvr {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // get union log
    val sql = s"""
                 |select iscvr as isclick, cast(raw_cvr as bigint) as ectr, left(adclass,6) as adclass, cvr_model_name, adslotid as adslot_id, cast(ideaid as string) ideaid,
                 ...
                 |  from dl_cpc.qtt_cvr_calibration_sample where dt = '2019-05-29'
       """.stripMargin
    println(s"sql:\n$sql")
