...
//        .withColumn("userid",when(col("useridtag")===1,col("userid")).otherwise(9999999))
      ...
      val categoricalColumns = Array("ideaid","adclass","adslot_id","unitid","userid","click_unit_count","conversion_from","siteid")
...
//      stagesArray.append(assembler)
      ...
      val lrModel = new LinearRegression().setFeaturesCol("features")
        ...
        .setLabelCol("label").setRegParam(0.01).setElasticNetParam(0.01).fit(trainingDF)
