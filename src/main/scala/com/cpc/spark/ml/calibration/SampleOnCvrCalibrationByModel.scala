...
object SampleOnCvrCalibrationByModel {
  def main(args: Array[String]): Unit = {
    ...
    printToFile(new File(s"/home/cpc/wy/calibration_sample/calibration_sample_$model.csv"),
   ...
   val move =s"hdfs dfs -put -f /home/cpc/wy/calibration_sample/calibration_sample_$model.csv hdfs://emr-cluster/user/cpc/wy/calibration_sample_$model.csv"
    move !
  }
