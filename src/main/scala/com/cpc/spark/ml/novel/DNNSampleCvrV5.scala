...
object DNNSampleCvrV5 {
  def main(args: Array[String]): Unit = {
    ...
    val sample = new DNNSampleCvrV5(spark, trdate, trpath, tedate, tepath)
    sample.saveTrain(trpath,100)
  }
}

class DNNSampleCvrV5(spark: SparkSession, trdate: String = "", trpath: String = "",
  ...
  private def getAsFeature(date: String): DataFrame = {
    ...
    val as_sql =
      s"""
         ...
         |  and adslotid not in ('7834151','7199174')
         |) a
         |inner join
