    ...
    def main(args: Array[String]): Unit = {
        ...
        val apiUnionLogSql =
            s"""
               ...
               |and (userid not in (1542903, 1522853,1534763,1533743,1538013,1538252,1515505,1552588,1549938,1546988,1557909,1552587, 1542903, 1553711, 1552154, 1559014, 1551248, 1538486, 1551950, 1559495, 1550108, 1551707, 1548568, 1558766, 1558705, 1559522, 1556256, 1548521, 1558838, 1559266, 1560432, 1559076, 1557344, 1540595, 1560225)
        ...
        val mlFeatureSql =
            s"""
               ...
               |    where b.userid in (1542903, 1522853,1534763,1533743,1538013,1538252,1515505,1552588,1549938,1546988,1557909,1552587, 1542903, 1553711, 1552154, 1559014, 1551248, 1538486, 1551950, 1559495, 1550108, 1551707, 1548568, 1558766, 1558705, 1559522, 1556256, 1548521, 1558838, 1559266, 1560432, 1559076, 1557344, 1540595, 1560225)
