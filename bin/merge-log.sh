...
$SPARK_HOME/bin/spark-submit --master yarn \
	...
	--jars "$cur/lib/mysql-connector-java-5.1.41-bin.jar,$cur/lib/cpc-protocol_2.11-1.0.jar" \
	--class com.cpc.spark.log.anal.AnalUnionLog \
	$cur/lib/cpc-anal_2.11-1.0.jar "/gobblin/source/cpc" "cpc_union_log" 1 && \
$SPARK_HOME/bin/spark-submit --master yarn \
	--executor-memory 2G --executor-cores 2 --total-executor-cores 6 \
	...
	$cur/lib/cpc-anal_2.11-1.0.jar "cpc_union_log" 2
