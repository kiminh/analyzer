...
$SPARK_HOME/bin/spark-submit --master yarn --queue $queue \
    ...
    --class com.cpc.spark.OcpcProtoType.model_novel_v3.OcpcSuggestCPAV3 \
    /home/cpc/wy/analyzer/target/scala-2.11/cpc-anal_2.11-0.1.jar 2019-05-25 10 novel_v3 novel 1