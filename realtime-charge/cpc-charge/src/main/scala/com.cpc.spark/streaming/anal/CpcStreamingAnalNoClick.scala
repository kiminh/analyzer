...
object CpcStreamingAnalNoClick {
  def main(args: Array[String]) {
    ...
    val topics = "cpc_search,cpc_show"
    val sparkConf = new SparkConf().setAppName("v3.1 cpc streaming anal no click topics = " + topics+ " env :" +env)
