...
object CpcStreamingAnalNoClickV2 {
  def main(args: Array[String]) {
    ...
    val sparkConf = new SparkConf().setAppName("v3.2 cpc streaming anal no click topics = " + topics + " env :" + env)
    ...
    val base_data = parserData.filter(_._1)
      .map {
    ...
    base_data.foreachRDD((x: RDD[(Int, Int, Int, Int, Int, Int, Int, String, Int, Int, Int, Int, Int, Int, String, String)]) => {
      x.coalesce(repartition.toInt)
        .foreachPartition {
          data =>
