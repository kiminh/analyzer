...
(
    ...
    media_appsid string,
    module_times string,
    groups_hit_ad_slot_ids string,
    groups_hit_not_allow_delivery_ids string,
    ideas_filtered_by_bidrankcut_ids string,
    ideas_filtered_by_middle_page_ids string,
    involved_ideas_ids string,
    matched_ideas_ids string,
    rnd_ideas_ids string
)
PARTITIONED by (`dt` STRING, `hour` STRING)
STORED as PARQUET;

CREATE TABLE IF NOT EXISTS dl_cpc.recall_filter_number_report_full
(
    searchid string,
    group_media_num int,
    group_region_num int,
    ...
    module_times string,
    groups_hit_ad_slot_ids string,
    groups_hit_not_allow_delivery string
)
PARTITIONED by (`dt` STRING, `hour` STRING)
STORED as PARQUET;
