...
$SPARK_HOME/bin/spark-submit --master yarn --queue $queue \
    ...
    --jars $( IFS=$','; echo "${jars[*]}" ) \
    --class com.cpc.spark.oCPX.oCPC.report.OcpcHourlyReport \
<<<<<<< HEAD
    /home/cpc/ghj/cpc/analyzer/target/scala-2.11/cpc-anal_2.11-0.1.jar $1 $2
=======
    /home/cpc/wangjun/analyzer/target/scala-2.11/cpc-anal_2.11-0.1.jar $1 $2
>>>>>>> a367cf04a022b7fc65fb18c23c03c23767843d60
